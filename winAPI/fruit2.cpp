...
HRESULT fruit2::init(float x, float y)
{
	tem.image = IMAGEMANAGER->addFrameImage("fruit2", "item/fruit2.bmp", 330, 78, 10, 2, true, RGB(255, 0, 255));
...
void fruit2::release(void)
{
}

void fruit2::update(void)
{
	if (tem.life)
	{
		// 카메라때매 계속 그려줘야 됨. 
...
void fruit2::PixelCollision(void)
{
	if (follow)
	{
		//tem.state = FLYHOLD;

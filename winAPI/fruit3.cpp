...
HRESULT fruit3::init(float x, float y)
{
	tem.image = IMAGEMANAGER->addFrameImage("fruit3", "item/fruit3.bmp", 330, 78, 10, 2, true, RGB(255, 0, 255));
...
void fruit3::release(void)
{
}

void fruit3::update(void)
{
	if (tem.life)
	{
		// 카메라때매 계속 그려줘야 됨. 
...
void fruit3::PixelCollision(void)
{
	if (follow)
	{
		//tem.state = FLYHOLD;

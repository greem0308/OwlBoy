...
HRESULT fruit1::init(float x, float y)
{
	tem.image = IMAGEMANAGER->addFrameImage("fruit1", "item/fruit1.bmp", 330, 78, 10, 2, true, RGB(255, 0, 255));
...
void fruit1::release(void)
{
}

void fruit1::update(void)
{
	if (tem.life)
	{
		// 카메라때매 계속 그려줘야 됨. 
...
void fruit1::PixelCollision(void)
{
	if (follow)
	{
		//tem.state = FLYHOLD;
